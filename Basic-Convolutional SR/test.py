...
"""The reason for using unsqueeze and squeeze is because your model expects a 4-dimensional input tensor with the 
...
(1, channels, height, width) that the model expects. After passing the input tensor through the model, the output 
